...
<div id="learn-press-zarinpal-form" class="<?php if (is_rtl()) echo ' learn-press-form-zarinpal-rtl'; ?>">
    <p class="learn-press-form-row">
        ...
        <input type="text" name="learn-press-zarinpal[email]" id="learn-press-zarinpal-payment-email" maxlength="19" value="" placeholder="test@zarinpal.com" />
    <div class="learn-press-zarinpal-form-clear"></div>
    </p>
    <div class="learn-press-zarinpal-form-clear"></div>
    <p class="learn-press-form-row">
        <label><?php echo wp_kses(__('Mobile', 'learnpress-zarinpal'), array('span' => array())); ?></label>
        <input type="text" name="learn-press-zarinpal[mobile]" id="learn-press-zarinpal-payment-mobile" value="" placeholder="09121111111" />
    <div class="learn-press-zarinpal-form-clear"></div>
    </p>
    <div class="learn-press-zarinpal-form-clear"></div>
</div>